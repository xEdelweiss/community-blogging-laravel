    ...
    @foreach ($topics as $topic)
        <li>
            <a href="{{ route('home', ['topic' => $topic]) }}"
                class="@if ($isSelected($topic)) bg-primary/10 dark:bg-gray-800 dark:text-blue-700 @endif group flex items-center rounded-lg px-3 py-2 text-left font-medium hover:bg-primary/20 dark:bg-gray-800 dark:hover:bg-gray-800 dark:hover:text-blue-700">
