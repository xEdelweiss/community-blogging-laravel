<div>
    <div class="comments-container relative my-8 ml-22 mt-2 space-y-6 pt-4">
            ...
            <div class="flex flex-1 px-5 py-6">
                ...
                <div class="mx-4 flex w-full flex-col justify-between">
                    ...
                    <div class="flex-1 text-gray-600">
                        ...
                        Corporis, cum non. Aliquam eaque ex perspiciatis. Dolor explicabo, fugiat id neque
                        perferendis possimus provident quis tempore! Amet assumenda deserunt dolores dolorum
                        impedit, maiores maxime mollitia odio quibusdam, quo reiciendis rem suscipit temporibus!
                        Dicta et hic iusto, minima praesentium rerum unde voluptatem.
                    </div>
        ...
        <div class="is-admin comment-container relative mt-4 flex rounded-xl bg-white">
            <div class="flex flex-1 px-5 py-6">
                <div class="flex-none">
                    <a href="#">
                    ...
                    <div class="text-blue mt-1 text-center text-xxs font-bold uppercase">Admin</div>
                </div>
                <div class="mx-4 flex w-full flex-col justify-between">
