...
<x-dropdown align="right" width="48">
    <x-slot name="trigger">
        <button
            class="dark:text-gray-400 dark:bg-gray-800 dark:hover:text-gray-300 flex items-center text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none">

            @auth
                <img src="https://source.unsplash.com/40x40/?face&crop=face" alt="avatar"
                    class="h-10 w-10 cursor-pointer rounded-xl" />
            @else
                <svg class="h-10 w-10 cursor-pointer rounded-xl" viewBox="0 0 61.7998 61.7998"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <g data-name="Layer 2" id="Layer_2">
                            <g data-name="—ÎÓÈ 1" id="_ÎÓÈ_1">
                                <path d="M23.255 38.68l15.907.146v15.602l-15.907-.147V38.68z" fill="#333333"
                                ...
                                <path d="M31.129 8.432c21.281 0 12.987 35.266 0 35.266-12.267 0-21.281-35.266 0-35.266z"
                                    fill="#ffe8be" fill-rule="evenodd"></path>
                                <path d="M18.365 24.045c-3.07 1.34-.46 7.687 1.472 7.658a31.973 31.973 0 0 1-1.472-7.658z"
                                    fill="#f9dca4" fill-rule="evenodd"></path>
                                <path d="M44.14 24.045c3.07 1.339.46 7.687-1.471 7.658a31.993 31.993 0 0 0 1.471-7.658z"
                                    fill="#f9dca4" fill-rule="evenodd"></path>
                                <path
