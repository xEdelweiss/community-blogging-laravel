@if ($criteria->tag || $criteria->topic)
    <div class="mb-4 ms-3 flex flex-col items-start gap-2">
        <a href="{{ routeWithout('topic') }}"
            ...
            @if ($criteria->topic)
                ...
                <span class="inline-block group-hover:hidden">
                    <img class="mr-3 h-6 w-6"
                        src="{{ asset($criteria->topic->image) }}"
                        alt="" />
                </span>
