<x-app-layout>
    <div class="mx-auto flex flex-col justify-between md:flex-row lg:gap-x-10" style="max-width: 1400px;">
        ...
        <div class="hidden sticky self-start max-w-[266px] 2xl:block" style="top: 40px;">
